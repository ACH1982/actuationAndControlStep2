...
#ifndef RTW_HEADER_FBIARINC_h_
#define RTW_HEADER_FBIARINC_h_
#include <stddef.h>
#include <cstring>
#include <logsrv.h>
#include "rtwtypes.h"
...
struct B_FBIARINC_T {
  FBI_ACExxxA_C_A BusAssignment;       /* '<S1>/Bus Assignment' */
  ...
  uint32_T Decode6;                    /* '<S1>/Decode 6' */
  uint32_T Decode3;                    /* '<S1>/Decode 3' */
  uint32_T Decode4;                    /* '<S1>/Decode 4' */
  real32_T Cast1;                      /* '<S1>/Cast1' */
  real32_T Cast2;                      /* '<S1>/Cast2' */
  real32_T FBI_AMP;
  ...
  uint8_T Cast3;                       /* '<S1>/Cast3' */
  uint8_T Cast4;                       /* '<S1>/Cast4' */
  uint8_T Cast5;                       /* '<S1>/Cast5' */
  ...
  boolean_T Decode1;                   /* '<S1>/Decode 1' */
  boolean_T Cast6;                     /* '<S1>/Cast6' */
  boolean_T FBI_ACT;
...
extern "C" {
  ...
  extern struct B_FBIARINC_T FBIARINC_B;
...
extern struct DW_FBIARINC_T FBIARINC_DW;
...
extern "C" {
  ...
  extern void FBIARINC_initialize(void);
  extern void FBIARINC_step(void);
  extern void FBIARINC_terminate(void);
...
extern "C" {
  ...
  extern RT_MODEL_FBIARINC_T *const FBIARINC_M;
 ...
 *
 * '<Root>' : 'FBIARINC'
 * '<S1>'   : 'FBIARINC/Decode Channel 1'
 * '<S2>'   : 'FBIARINC/Decode Channel 1/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_FBIARINC_h_ */
