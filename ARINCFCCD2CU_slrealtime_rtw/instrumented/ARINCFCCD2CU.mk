###########################################################################
## Makefile generated for component 'ARINCFCCD2CU'. 
## 
## Makefile     : ARINCFCCD2CU.mk
## Generated on : Tue May 17 10:42:54 2022
## Final product: $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU
...
PRODUCT = $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU
...
DEFINES_STANDARD = -DMODEL=ARINCFCCD2CU -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU_cal.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtmodel.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/signal_encode_cgen_wrapper.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rte_ARINCFCCD2CU_parameters.cpp $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_arinc429_encode_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_send_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_setup_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/src/sg_io682_v3.cpp $(START_DIR)/signal_encode_wrapper.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o ARINCFCCD2CU.o ARINCFCCD2CU_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rtmodel.o signal_encode_cgen_wrapper.o rte_ARINCFCCD2CU_parameters.o main.o sg_arinc429_encode_s_v2.o sg_io682_send_s_v3.o sg_io682_setup_s_v3.o sg_io682_v3.o signal_encode_wrapper.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


ARINCFCCD2CU.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


ARINCFCCD2CU_cal.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/ARINCFCCD2CU_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtmodel.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rtmodel.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


signal_encode_cgen_wrapper.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/signal_encode_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_ARINCFCCD2CU_parameters.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/rte_ARINCFCCD2CU_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/ARINCFCCD2CU_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
