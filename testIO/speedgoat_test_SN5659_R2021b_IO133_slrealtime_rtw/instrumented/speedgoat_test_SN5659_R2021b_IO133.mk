###########################################################################
## Makefile generated for component 'speedgoat_test_SN5659_R2021b_IO133'. 
## 
## Makefile     : speedgoat_test_SN5659_R2021b_IO133.mk
## Generated on : Fri Apr 08 16:37:08 2022
## Final product: $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133
...
PRODUCT_NAME              = speedgoat_test_SN5659_R2021b_IO133
MAKEFILE                  = speedgoat_test_SN5659_R2021b_IO133.mk
...
PRODUCT = $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133
...
DEFINES_STANDARD = -DMODEL=speedgoat_test_SN5659_R2021b_IO133 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133_cal.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO133_parameters.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/sg_IO132_IO133_ad_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/sg_IO132_IO133_da_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/sg_IO132_IO133_di_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/sg_IO132_IO133_do_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/sg_IO132_IO133_setup_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/analog/src/sg_io132.c host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o rtGetInf.o rtGetNaN.o rt_nonfinite.o speedgoat_test_SN5659_R2021b_IO133.o speedgoat_test_SN5659_R2021b_IO133_cal.o rte_speedgoat_test_SN5659_R2021b_IO133_parameters.o main.o sg_IO132_IO133_ad_s_v2.o sg_IO132_IO133_da_s_v2.o sg_IO132_IO133_di_s_v2.o sg_IO132_IO133_do_s_v2.o sg_IO132_IO133_setup_s_v2.o sg_io132.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO133.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO133_cal.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO133_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_speedgoat_test_SN5659_R2021b_IO133_parameters.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO133_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO133_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
