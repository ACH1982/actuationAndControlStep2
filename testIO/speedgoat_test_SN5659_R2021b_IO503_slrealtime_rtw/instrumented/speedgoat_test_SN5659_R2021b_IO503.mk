###########################################################################
## Makefile generated for component 'speedgoat_test_SN5659_R2021b_IO503'. 
## 
## Makefile     : speedgoat_test_SN5659_R2021b_IO503.mk
## Generated on : Fri Apr 08 16:58:36 2022
## Final product: $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503
...
PRODUCT_NAME              = speedgoat_test_SN5659_R2021b_IO503
MAKEFILE                  = speedgoat_test_SN5659_R2021b_IO503.mk
...
PRODUCT = $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1/SG_BLO~1/common/libsg -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1/SG_BLO~1/serial/include
...
DEFINES_STANDARD = -DMODEL=speedgoat_test_SN5659_R2021b_IO503 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503_cal.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/slfiforeadwrite.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO503_parameters.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/serial/sg_serial_read_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/serial/sg_serial_setup_s.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/serial/sg_serial_write_s.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/slasciidecode.cpp $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/slasciiencode.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/serial/src/sg_serial.c $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o rtGetInf.o rtGetNaN.o rt_nonfinite.o speedgoat_test_SN5659_R2021b_IO503.o speedgoat_test_SN5659_R2021b_IO503_cal.o slfiforeadwrite.o rte_speedgoat_test_SN5659_R2021b_IO503_parameters.o main.o sg_serial_read_s.o sg_serial_setup_s.o sg_serial_write_s.o slasciidecode.o slasciiencode.o sg_serial.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
LIBS = $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/lib/libecatinterface_slrt_x64.a $(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/lib/libEcMaster_slrt_x64.a
...
%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO503.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO503_cal.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO503_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
rte_speedgoat_test_SN5659_R2021b_IO503_parameters.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO503_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_code_profiling_utility_functions.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO503_slrealtime_rtw/slrealtime_code_profiling_utility_functions.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
