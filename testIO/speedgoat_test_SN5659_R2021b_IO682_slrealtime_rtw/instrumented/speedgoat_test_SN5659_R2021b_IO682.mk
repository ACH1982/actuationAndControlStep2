###########################################################################
## Makefile generated for component 'speedgoat_test_SN5659_R2021b_IO682'. 
## 
## Makefile     : speedgoat_test_SN5659_R2021b_IO682.mk
## Generated on : Fri Apr 08 14:58:59 2022
## Final product: $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682
...
PRODUCT_NAME              = speedgoat_test_SN5659_R2021b_IO682
MAKEFILE                  = speedgoat_test_SN5659_R2021b_IO682.mk
...
PRODUCT = $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1/SG_BLO~1/common/libsg -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1/SG_BLO~1/arinc429/include -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2021b/940~1.1/SG_BLO~1/arinc429/lib/sg_IO682/include
...
DEFINES_STANDARD = -DMODEL=speedgoat_test_SN5659_R2021b_IO682 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682_cal.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO682_parameters.cpp $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_arinc429_decode_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_arinc429_encode_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_receive_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_send_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_setup_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/src/sg_io682_v3.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o rtGetInf.o rtGetNaN.o rt_nonfinite.o speedgoat_test_SN5659_R2021b_IO682.o speedgoat_test_SN5659_R2021b_IO682_cal.o rte_speedgoat_test_SN5659_R2021b_IO682_parameters.o main.o sg_arinc429_decode_s_v2.o sg_arinc429_encode_s_v2.o sg_io682_receive_s_v3.o sg_io682_send_s_v3.o sg_io682_setup_s_v3.o sg_io682_v3.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
LIBS = C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/lib/sg_IO682/sg_IO682_qnx710_x86_64.a
...
%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO682.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_IO682_cal.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/speedgoat_test_SN5659_R2021b_IO682_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_speedgoat_test_SN5659_R2021b_IO682_parameters.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_IO682_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_IO682_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
