###########################################################################
## Makefile generated for component 'speedgoat_test_SN5659_R2021b'. 
## 
## Makefile     : speedgoat_test_SN5659_R2021b.mk
## Generated on : Fri Apr 08 16:05:10 2022
## Final product: $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/speedgoat_test_SN5659_R2021b
...
PRODUCT_NAME              = speedgoat_test_SN5659_R2021b
MAKEFILE                  = speedgoat_test_SN5659_R2021b.mk
...
PRODUCT = $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/speedgoat_test_SN5659_R2021b
...
DEFINES_STANDARD = -DMODEL=speedgoat_test_SN5659_R2021b -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
LIBS = C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/lib/sg_IO682/sg_IO682_qnx710_x86_64.a C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/can/include/IO61X_Library_qnx710_x86_64.a
...
%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


can_datatype_ground.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/can_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtmodel.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/rtmodel.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/speedgoat_test_SN5659_R2021b.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


speedgoat_test_SN5659_R2021b_cal.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/speedgoat_test_SN5659_R2021b_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_speedgoat_test_SN5659_R2021b_parameters.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/rte_speedgoat_test_SN5659_R2021b_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/speedgoat_test_SN5659_R2021b_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
