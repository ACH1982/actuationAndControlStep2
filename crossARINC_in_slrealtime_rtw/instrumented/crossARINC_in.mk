###########################################################################
## Makefile generated for component 'crossARINC_in'. 
## 
## Makefile     : crossARINC_in.mk
## Generated on : Tue May 17 12:21:38 2022
## Final product: $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in
...
PRODUCT = $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in
...
DEFINES_STANDARD = -DMODEL=crossARINC_in -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/crossARINC_in_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in_cal.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/signal_decode_cgen_wrapper.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/rte_crossARINC_in_parameters.cpp $(START_DIR)/crossARINC_in_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_arinc429_decode_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_receive_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_setup_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/src/sg_io682_v3.cpp $(START_DIR)/signal_decode_wrapper.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o crossARINC_in.o crossARINC_in_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o signal_decode_cgen_wrapper.o rte_crossARINC_in_parameters.o main.o sg_arinc429_decode_s_v2.o sg_io682_receive_s_v3.o sg_io682_setup_s_v3.o sg_io682_v3.o signal_decode_wrapper.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


crossARINC_in.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


crossARINC_in_cal.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/crossARINC_in_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


signal_decode_cgen_wrapper.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/signal_decode_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_crossARINC_in_parameters.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/rte_crossARINC_in_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/crossARINC_in_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
signal_decode_wrapper.o : $(START_DIR)/signal_decode_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
