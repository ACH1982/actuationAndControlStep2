###########################################################################
## Makefile generated for component 'crossARINC_out'. 
## 
## Makefile     : crossARINC_out.mk
## Generated on : Fri May 13 11:44:57 2022
## Final product: $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out
...
PRODUCT_NAME              = crossARINC_out
MAKEFILE                  = crossARINC_out.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/angel/Documents/GitHub/actuationAndControlStep2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out
...
DEFINES_STANDARD = -DMODEL=crossARINC_out -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/crossARINC_out_slrealtime_rtw/slrealtime_datatype_ground.c $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out_cal.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/rtGetInf.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/rtGetNaN.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/rt_nonfinite.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/signal_encode_cgen_wrapper.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/rte_crossARINC_out_parameters.cpp $(START_DIR)/crossARINC_out_slrealtime_rtw/main.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_arinc429_encode_s_v2.c C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_send_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/sg_io682_setup_s_v3.cpp C:/ProgramData/Speedgoat/speedgoatlib/R2021b/9.4.0.1/sg_blocks/arinc429/src/sg_io682_v3.cpp $(START_DIR)/signal_encode_wrapper.cpp host_timer_x86.c slrealtime_code_profiling_utility_functions.cpp
...
OBJS = rt_matrx.o rt_printf.o slrealtime_datatype_ground.o crossARINC_out.o crossARINC_out_cal.o rtGetInf.o rtGetNaN.o rt_nonfinite.o signal_encode_cgen_wrapper.o rte_crossARINC_out_parameters.o main.o sg_arinc429_encode_s_v2.o sg_io682_send_s_v3.o sg_io682_setup_s_v3.o sg_io682_v3.o signal_encode_wrapper.o host_timer_x86.o slrealtime_code_profiling_utility_functions.o
...
%.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
slrealtime_datatype_ground.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/slrealtime_datatype_ground.c
	$(CC) $(CFLAGS) -o $@ $<


crossARINC_out.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


crossARINC_out_cal.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/crossARINC_out_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


signal_encode_cgen_wrapper.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/signal_encode_cgen_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_crossARINC_out_parameters.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/rte_crossARINC_out_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/crossARINC_out_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
signal_encode_wrapper.o : $(START_DIR)/signal_encode_wrapper.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
