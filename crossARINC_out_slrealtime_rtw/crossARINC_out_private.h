...
#ifndef RTW_HEADER_crossARINC_out_private_h_
#define RTW_HEADER_crossARINC_out_private_h_
#include "rtwtypes.h"
...
SFB_EXTERN_C void signal_encode_Start_wrapper(const real_T *scale, const int_T
  p_width0,
...
SFB_EXTERN_C void signal_encode_Outputs_wrapper(const real_T *data,
  uint32_T *out,
  ...
  const boolean_T *swap, const int_T p_width3,
  const uint32_T *size, const int_T p_width4);
SFB_EXTERN_C void signal_encode_Terminate_wrapper(const real_T *scale, const
  int_T p_width0,
  const real_T *offset, const int_T p_width1,
  const boolean_T *signed_c2, const int_T p_width2,
  const boolean_T *swap, const int_T p_width3,
...
#endif                                /* RTW_HEADER_crossARINC_out_private_h_ */
