 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue May 17 11:16:41 2022
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                signal_decode
...
{
  const uint32_T *data = (uint32_T *) ssGetInputPortRealSignal(S, 0);
  ...
  signal_decode_Outputs_wrapper(data, out, scale, p_width0, offset, p_width1,
